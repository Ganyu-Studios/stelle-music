...
import { ParserRecommendedConfig, DeclareParserConfig, Watch, Yuna } from "yunaforseyfert";
import { sliceText, getDepth } from "#stelle/utils/functions/utils.js";
            ...
            await ctx.editOrReply({
                embeds: [
                    new Embed()
                        ...
                        .setDescription(`\`📖\` A code has been evaluated.\n \n${Formatter.codeBlock(sliceText(output, 1_900), "js")}`)
                        ...
                        .addFields(
                            ...
                            {
                                name: "`📥` Input",
                                value: Formatter.codeBlock(sliceText(options.code, 1_024), "js")
                            },
                            {
                                name: "`📤` Output",
                                value: "Check the embed description."
                            }
                        )
                ]
            });
                ...
                embeds: [
                    new Embed()
                        ...
                        .addFields(
                            ...
                            {
                                name: "`📤` Output",
                                value: Formatter.codeBlock(sliceText(String(error), 1_024), "js")
                            }
                        )
                ]
            });
